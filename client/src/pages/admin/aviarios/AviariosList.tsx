                                                                                    ...
                                                                                    <div className="flex flex-col gap-2">
                                                                                        ...
                                                                                        <div className="flex items-center justify-between mt-auto">
                                                                                            ...
                                                                                            <div className="flex gap-1" onClick={e => e.stopPropagation()}>
                                                                                                ...
                                                                                                <button onClick={() => handleShowQR(cage.qr_code || `GAIOLA:${cage.id}`, `${cage.name || cage.nome} - Grupo: ${group.nome}`)} className="p-1.5 text-indigo-500 hover:text-indigo-700 hover:bg-indigo-50 rounded-lg transition-colors border border-transparent hover:border-indigo-100">
                                                                                                    <QrCode size={14} />
                                                                                                </button>
